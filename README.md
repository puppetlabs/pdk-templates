...
| Key            | Description   |
| :------------- |:--------------|
| simplecov      |Define whether to on simplecov code coverage with your 'bundle exec rake '$CHECK'  script:.|
...
| Key            | Description   |
| :------------- |:--------------|
|requires|A hash of requires to be added, including an optional conditional.|
